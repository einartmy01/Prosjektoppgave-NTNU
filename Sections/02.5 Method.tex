...
It is difficult to determine if the aspects I have focused on is the best and correct way to compare and find a good solution. However, as I will also discuss in Chapter \ref{sec:ResultsDiscussion} "Results and Discussion", many of the other vehicle industries have decided to focus on the same aspects. 

\subsection{Reliability}
This report takes a varying span of reports from different industries before trying to compare. By the amount of papers read, and the amount of papers used, I believe to have found a pretty general results in the theme of latency and threshold that any other will be able to duplicate, even with none of the same reports. As this is very broad examination of the topic the general result should be reproducible.
For the subject of how we can test and evaluate tools and protocol, other people will be able to come to a different conclusion as it is more personal and decided from specific previous examples.