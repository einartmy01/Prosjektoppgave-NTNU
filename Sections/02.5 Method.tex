...
To be able to choose from multiple thousands papers down to the ones chosen, a filtration method has been used. Numbers are based on the example of 33 700 for \textit{"Remote" "Latency" "Threshold" "Operation" OR "Control"}

\textit{Make diagram out of this:}
1. Remove phase, all duplicated or non-English papers was ignored. 27 000
2. Headline filtration, an estimate on how relevant it appears to be for this research based on headline, amount of citations and year produce where newer papers was judges easily on citations.60
3. Abstract reading, reading threw abstract, looking for relevant context of the papers to. 35
4. Full reading, reading threw the papers, confirming value for the review and research, looking for useful information that could contribute to this scoping review. 20
5. Selection, Papers adding new perspective not already discussed by another paper, or papers reconfirming other papers. 8
