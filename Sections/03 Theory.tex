...
Remote Train Operations (RTO), as we will discuss in this paper, is a part of stage GoA~3 as a disruption management handling system and as a safety system for GoA~4 if it were to fail. \cite{brandenburger2023vqreactiontimertc}
...
\subsubsection{Levels} %Må muligens bli subsubsections igjen
...
In the table we can see end to end latency being mentioned, and they have defined it as the same as G2G \cite{3gppts22289}
